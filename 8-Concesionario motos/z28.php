...
<!-- The four columns -->
		<div class="row">
		    <div class="column">
		    	<img src="img/Concesionario_motos/Cubs/Honda/biz 125/1_biz125.jpg" alt="" style="width:100%" onclick="myFunction(this);">
		  	</div>
		  	<div class="column">
		    	<img src="img/Concesionario_motos/Cubs/Honda/biz 125/2_biz125.jpg" alt="" style="width:100%" onclick="myFunction(this);">
		  	</div>
		  	<div class="column">
		    	<img src="img/Concesionario_motos/Cubs/Honda/biz 125/3_biz125.jpg" alt="" style="width:100%" onclick="myFunction(this);">
		  	</div>
		  	<div class="column">
		    	<img src="img/Concesionario_motos/Cubs/Honda/biz 125/4_biz125.jpg" alt="" style="width:100%" onclick="myFunction(this);">
		  	</div>
		  	<div class="column">
		    	<img src="img/Concesionario_motos/Cubs/Honda/biz 125/5_biz125.jpg" alt="" style="width:100%" onclick="myFunction(this);">
		  	</div>
		  	<div class="column">
		    	<img src="img/Concesionario_motos/Cubs/Honda/biz 125/6_biz125.jpg" alt="" style="width:100%" onclick="myFunction(this);">
		  	</div>
		  	<div class="column">
		    	<img src="img/Concesionario_motos/Cubs/Honda/biz 125/7_biz125.jpg" alt="" style="width:100%" onclick="myFunction(this);">
		  	</div>
		</div>
			...
			<div class="row">
				<div class="col-md-8">
					<table style="width:80%">
						...
						<tr>
							<td>Motor</td>
							<td>Monocilí­ndrico, 4 tiempos</td>
						</tr>
						<tr>
							<td>Cilindrada</td>
							<td>124,9 cc</td>
