...
<html lang="es">
	<head>
		...
		<title>Venta de motos-Enduro</title>
  				...
  				<ul class="nav nav-tabs">
					...
					<li class="nav-item dropdown">
						...
						<div class="dropdown-menu">
						    ...
						    <a class="dropdown-item" href="#"><img src="img/logos-menu/logo-gilera.gif" alt="Gilera"></a>
				...
				<div class="row">
					...
					<div class="col-md-5">
						<div class="card alex" ><!--style="width: 500px !important;"-->
							<img class="lima eco" src="img/Concesionario_motos/Enduro/Gilera en/sahel 150/1_SAHEL.png" alt="Gilera">
							<div class="overlay">
	...
	<hr>
		<div class="container">
			<ul class="breadcrumb justify-content-center">
			    <li class="breadcrumb-item"><a href="enduro1corven.php">Coven</a></li>
			    <li class="breadcrumb-item active">Gilera</li>
			    <li class="breadcrumb-item"><a href="enduro3Motomel.php">Motomel</a></li>
 			</ul>
		</div>
	<hr>
