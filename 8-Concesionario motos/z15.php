...
<html lang="es">
	...
	<body>
		...
		<div style="text-align:center">
		  	<h2>Gilera Vc 150 Vs</h2>
		</div>

<!-- The four columns -->
		<div class="row">
		    <div class="column">
		    	<img src="img/Concesionario_motos/Street/gilera st/vc 150 vs/1_vc.png" alt="" style="width:100%" onclick="myFunction(this);">
		  	</div>
		  	<div class="column">
		    	<img src="img/Concesionario_motos/Street/gilera st/vc 150 vs/2_vc.png" alt="" style="width:100%" onclick="myFunction(this);">
		  	</div>
		  	<div class="column">
		    	<img src="img/Concesionario_motos/Street/gilera st/vc 150 vs/3_vc.png" alt="" style="width:100%" onclick="myFunction(this);">
		  	</div>
		  	<div class="column">
		    	<img src="img/Concesionario_motos/Street/gilera st/vc 150 vs/4_vc.png" alt="" style="width:100%" onclick="myFunction(this);">
		  	</div>
		  	<div class="column">
		    	<img src="img/Concesionario_motos/Street/gilera st/vc 150 vs/5_vc.png" alt="" style="width:100%" onclick="myFunction(this);">
		  	</div>
		</div>
			...
			<div class="row">
				<div class="col-md-8">
					<table style="width:80%">
						...
						<tr>
							<td>freno trasero</td>
							<td>tambor de expansión interna</td>
						</tr>
					</table>
