		...
		<div class="jumbotron jumbotron-fluid">
				...
				<div class="row">
					...
					<div class="col-md-5">
						<div class="card alex" ><!--style="width: 500px !important;"-->
							...
							<div class="overlay">
    							<div class="text">Gilera C110 Pronto</div>
  							</div>
						</div>
			...
			<div class="container-fluid">
				<div class="row">
					...
					<div class="col-md-5">
						<div class="card alex">
							<img class="lima eco" src="img/Concesionario_motos/Cubs/Gilera/smash 125 x/1_smashx-slider.png" alt="Gilera">
							<div class="overlay1">
    							<div class="text">Gilera Smash 125 X</div>
  							</div>
						</div>
