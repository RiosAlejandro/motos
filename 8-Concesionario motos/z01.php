...
<html lang="es">
	...
	<body>
		...
		<div style="text-align:center">
		  	<h2>Gilera Smash 125X</h2>
		</div>

<!-- The four columns -->
		<div class="row">
		    <div class="column">
		    	<img src="img/Concesionario_motos/Cubs/Gilera/smash 125 x/1_smashx-slider.png" alt="" style="width:100%" onclick="myFunction(this);">
		  	</div>
		  	<div class="column">
		    	<img src="img/Concesionario_motos/Cubs/Gilera/smash 125 x/2_W.jpeg" alt="" style="width:100%" onclick="myFunction(this);">
		  	</div>
		  	<div class="column">
		    	<img src="img/Concesionario_motos/Cubs/Gilera/smash 125 x/3_w.jpeg" alt="" style="width:100%" onclick="myFunction(this);">
		  	</div>
		  	<div class="column">
		    	<img src="img/Concesionario_motos/Cubs/Gilera/smash 125 x/4_w.jpeg" alt="" style="width:100%" onclick="myFunction(this);">
		  	</div>
		  	<div class="column">
		    	<img src="img/Concesionario_motos/Cubs/Gilera/smash 125 x/5_w.jpeg" alt="" style="width:100%" onclick="myFunction(this);">
		  	</div>
		</div>
				...
				<div class="col-md-8">
					<table style="width:80%">
						...
						<tr>
							...
							<td>a tambor, de expansion interna</td>
						</tr>
						<tr>
							<td>Freno trasero</td>
							<td>a tambor, de expansion interna</td>
