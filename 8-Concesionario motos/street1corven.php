...
<html lang="es">
	<head>
		...
		<title>Venta de motos-Street</title>
				...
				<div class="row">
					...
					<div class="col-md-5">
						<div class="card alex" ><!--style="width: 500px !important;"-->
							<img class="lima eco" src="img/Concesionario_motos/Street/corven st/dx 70/1_DX-70.png" alt="Corven">
							<div class="overlay">
				...
				<div class="row">
					...
					<div class="col-md-5">
						<div class="card alex">
							...
							<div class="overlay1">
    							<div class="text">Corven Hunter 150</div>
  							</div>
						</div>
	...
	<hr>
		<div class="container">
			<ul class="breadcrumb justify-content-center">
			    ...
			    <li class="breadcrumb-item"><a href="street2gilera.php">Gilera</a></li>
			    <li class="breadcrumb-item"><a href="street3Motomel.php">Motomel</a></li>
			    <li class="breadcrumb-item"><a href="street4yamaha.php">Yamaha</a></li>
 			</ul>
		</div>
	<hr>
