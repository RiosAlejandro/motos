	...
	<body>
		<div class="jumbotron jumbotron-fluid">
  				...
  				<ul class="nav nav-tabs">
  					<li class="nav-item dropdown">
					    ...
					    <div class="dropdown-menu">
					      ...
					      <a class="dropdown-item" href="#"><img src="img/logos-menu/logo_honda.gif" alt="Honda"></a>
			...
			<div class="container-fluid">
				<div class="row">
					...
					<div class="col-md-5">
						<div class="card alex">
							<img class="lima eco" src="img/Concesionario_motos/Cubs/Honda/wave/1_wave.jpg" alt="Honda">
							<div class="overlay1">
		...
		<div class="container">
			<ul class="breadcrumb justify-content-center">
			    ...
			    <li class="breadcrumb-item active">Honda</li>
