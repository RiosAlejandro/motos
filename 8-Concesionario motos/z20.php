...
<html lang="es">
	...
	<body>
		...
		<div style="text-align:center">
		  	<h2>Gilera Smash Tunning</h2>
		</div>

<!-- The four columns -->
		<div class="row">
		    <div class="column">
		    	<img src="img/Concesionario_motos/Cubs/Gilera/smash tunning/1_SMASHTUNNING.png" alt="" style="width:100%" onclick="myFunction(this);">
		  	</div>
		  	<div class="column">
		    	<img src="img/Concesionario_motos/Cubs/Gilera/smash tunning/smash-tunning-1.jpg" alt="" style="width:100%" onclick="myFunction(this);">
		  	</div>
		  	<div class="column">
		    	<img src="img/Concesionario_motos/Cubs/Gilera/smash tunning/smash-tunning-2.jpg" alt="" style="width:100%" onclick="myFunction(this);">
		  	</div>
		  	<div class="column">
		    	<img src="img/Concesionario_motos/Cubs/Gilera/smash tunning/smash-tunning-3.jpg" alt="" style="width:100%" onclick="myFunction(this);">
		  	</div>
		  	<div class="column">
		    	<img src="img/Concesionario_motos/Cubs/Gilera/smash tunning/smash-tunning-4.jpg" alt="" style="width:100%" onclick="myFunction(this);">
		  	</div>
		</div>
				...
				<div class="col-md-8">
					<table style="width:80%">
						...
						<tr>
							...
							<td>De disco con accionamiento hidráulico</td>
						</tr>
						<tr>
							<td>Freno trasero</td>
							<td>De expansión interna accionado a pedal</td>
						</tr>
					</table>
