		...
		<div class="jumbotron jumbotron-fluid">
			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-5">
						<div class="card alex">
							<img class="lima eco" src="img/Concesionario_motos/Enduro/corven en/triax txr 250 x/1_TXR-250-X.png" alt="Corven">
							<div class="overlay">
    							<div class="text">Corven Triax Txr 250 X</div>
  							</div>						  					
						</div>
						<button style="width:100%" type="button" class="btn btn-primary" OnClick="location.href='z09.php'">
						    Info
						</button>
					<hr>
						<div class="card alex">
							<img class="lima eco" src="img/Concesionario_motos/Cubs/Corven/energy s110/1_Energy-S.png" alt="Corven">
							<div class="overlay">
    							<div class="text">Corven Energy S 110</div>
  							</div>						   						
						</div>
						<button style="width:100%" type="button" class="btn btn-primary" OnClick="location.href='z10.php'">
						    Info
						</button>
						<hr>
					</div>
					<div class="col-md-5">
						<div class="card alex">
							<img class="lima eco" src="img/Concesionario_motos/Cubs/Gilera/c110 pronto/1_c-110.jpg" alt="Gilera">
							<div class="overlay1">
    							<div class="text">Gilera C 110 Pronto</div>
  							</div>						    
						</div>
						<button style="width:100%" type="button" class="btn btn-primary" OnClick="location.href='z11.php'">
						    Info
						</button>
						<hr>
						<div class="card alex">
							<img class="lima eco" src="img/Concesionario_motos/Street/motomel st/s2/1_S2_150.png" alt="Motomel">
							<div class="overlay1">
    							<div class="text">Motomel S2</div>
  							</div>						    						
						</div>
						<button style="width:100%" type="button" class="btn btn-primary" OnClick="location.href='z12.php'">
						    Info
						</button>
						<hr>
					</div>
				...
				<div class="row">
					<div class="col-md-5">
						<div class="card alex">
							<img class="lima eco" src="img/Concesionario_motos/Enduro/Motomel en/Skua 150 v6/1_SKUA-150.png" alt="Motomel">
							<div class="overlay">
    							<div class="text">Motomel Skua 150 V6</div>
  							</div>						    
						</div>
						<button style="width:100%" type="button" class="btn btn-primary" OnClick="location.href='z13.php'">
						    Info
						</button>
						<hr>
					</div>
					<div class="col-md-5">
						<div class="card alex">
							<img class="lima eco" src="img/Concesionario_motos/Street/corven st/Hunter 150/1_Hunter-150.png" alt="Corven">
							<div class="overlay1">
    							<div class="text">Coven Hunter 150</div>
  							</div>						    
						</div>
						<button style="width:100%" type="button" class="btn btn-primary" OnClick="location.href='z14.php'">
						    Info
						</button>
						<hr>
					</div>
				...
				<div class="row">
					<div class="col-md-5">
						<div class="card alex">
							<img class="lima eco" src="img/Concesionario_motos/Street/gilera st/vc 150 vs/1_vc.png" alt="Gilera">
							<div class="overlay">
    							<div class="text">Gilera Vc 150 Vs</div>
  							</div>
						</div>
						<button style="width:100%" type="button" class="btn btn-primary" OnClick="location.href='z15.php'">
						    Info
						</button>
						<hr>
					</div>
					<div class="col-md-5">
						<div class="card alex">
							<img class="lima eco" src="img/Concesionario_motos/Cubs/Corven/mirage 110 r2/1_Mirage-110-R2.png" alt="Corven">
							<div class="overlay1">
    							<div class="text">Corven Mirage 110 R2</div>
  							</div> 
						</div>
						<button style="width:100%" type="button" class="btn btn-primary" OnClick="location.href='z16.php'">
						    Info
						</button>
						<hr>
					</div>
			...
			<div class="container">
				<ul class="pagination justify-content-center">
					...
					<li class="page-item"><a href="index_motos.php" class="page-link">1</a></li>
					<li class="page-item active"><a href="#" class="page-link">2</a></li>
					<li class="page-item"><a href="seccion3.php" class="page-link">3</a></li>
