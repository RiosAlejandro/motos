		...
		<div class="jumbotron jumbotron-fluid">
			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-5">
						<div class="card alex">
							<img class="lima eco" src="img/Concesionario_motos/Street/gilera st/vc 150 r/1_vc-150-r.jpg" alt="Gilera">
							<div class="overlay">
    							<div class="text">Gilera Vc 150 R</div>
  							</div>
						</div>
						<button style="width:100%" type="button" class="btn btn-primary" OnClick="location.href='z25.php'">
						    Info
						</button>
					<hr>
						<div class="card alex">
							<img class="lima eco" src="img/Concesionario_motos/Cubs/Motomel/dlx deluxe/1_DLX-Deluxe.png" alt="Motomel">
							<div class="overlay">
    							<div class="text">Motomel Dlx Deluxe</div>
  							</div>
						</div>
						<button style="width:100%" type="button" class="btn btn-primary" OnClick="location.href='z26.php'">
						    Info
						</button>
						<hr>
					</div>
					<div class="col-md-5">
						<div class="card alex">
							<img class="lima eco" src="img/Concesionario_motos/Enduro/Gilera en/smx 250/1_smx250.png" alt="Gilera">
							<div class="overlay1">
    							<div class="text">Gilera Smx 250</div>
  							</div>
						</div>
						<button style="width:100%" type="button" class="btn btn-primary" OnClick="location.href='z27.php'">
						    Info
						</button>
						<hr>
						<div class="card alex">
							<img class="lima eco" src="img/Concesionario_motos/Cubs/Honda/biz 125/1_biz125.jpg" alt="Honda">
							<div class="overlay1">
    							<div class="text">Honda Biz 125</div>
  							</div>
						</div>
						<button style="width:100%" type="button" class="btn btn-primary" OnClick="location.href='z28.php'">
						    Info
						</button>
						<hr>
					</div>
				...
				<div class="row">
					<div class="col-md-5">
						<div class="card alex">
							<img class="lima eco" src="img/Concesionario_motos/Street/Yamaha/ybr 125 z/1.jpg" alt="Yamaha">
							<div class="overlay">
    							<div class="text">Yamaha Ybr 125 Z</div>
  							</div>
						</div>
						<button style="width:100%" type="button" class="btn btn-primary" OnClick="location.href='z29.php'">
						    Info
						</button>
						<hr>
					</div>
					<div class="col-md-5">
						<div class="card alex">
							<img class="lima eco" src="img/Concesionario_motos/Cubs/Corven/energy 110 tunning/1_Energy-Tuning.png" alt="Corven">
							<div class="overlay1">
    							<div class="text">Corven Energy 110 Tunning</div>
  							</div>
						</div>
						<button style="width:100%" type="button" class="btn btn-primary" OnClick="location.href='z30.php'">
						    Info
						</button>
						<hr>
					</div>
				...
				<div class="row">
					...
					<div class="col-md-5">
						<div class="card alex">
							<img class="lima eco" src="img/Concesionario_motos/Enduro/Gilera en/smx 200 motard/1_smx-200-motard.jpg" alt="Gilera">
							<div class="overlay">
    							<div class="text">Gilera Smx 200 Motard</div>
  							</div>
						</div>
						<button style="width:100%" type="button" class="btn btn-primary" OnClick="location.href='z31.php'">
						    Info
						</button>
						<hr>
					</div>
