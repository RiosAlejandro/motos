  				...
  				<ul class="nav nav-tabs">
  					<li class="nav-item dropdown">
					    ...
					    <div class="dropdown-menu">
					      ...
					      <a class="dropdown-item" href="#"><img src="img/logos-menu/logo-motomel.gif" alt="Motomel"></a>
					    </div>
					</li>
					<li class="nav-item dropdown">
				...
				<div class="row">
					...
					<div class="col-md-5">
						<div class="card alex" ><!--style="width: 500px !important;"-->
							<img class="lima eco" src="img/Concesionario_motos/Cubs/Motomel/blitz/1_motomel-blitz.jpg" alt="Motomel">
							<div class="overlay">
	...
	<hr>
		<div class="container">
			<ul class="breadcrumb justify-content-center">
			    <li class="breadcrumb-item"><a href="cubs1corven.php">Coven</a></li>
			    <li class="breadcrumb-item"><a href="cubs2gilera.php">Gilera</a></li>
			    <li class="breadcrumb-item"><a href="cubs3Motomel.php">Honda</a></li>
			    <li class="breadcrumb-item active">Motomel</li>
 			</ul>
		</div>
	<hr>
