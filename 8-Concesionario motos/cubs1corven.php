...
<html lang="es">
	...
	<body>
		<div class="jumbotron jumbotron-fluid">
			...
			<!--<div class="jumbotron">
				<img src="img/Concesionario_motos/portada-motos/portadaCorven.jpg" alt="Corven">
			</div>
				<hr>-->
			<div class="container-fluid">
				<div class="row">
					...
					<div class="col-md-5">
						<div class="card alex" ><!--style="width: 500px !important;"-->
	...
	<hr>
		<div class="container">
			<ul class="breadcrumb justify-content-center">
			    <li class="breadcrumb-item active">Coven</li>
			    <li class="breadcrumb-item"><a href="cubs2gilera.php">Gilera</a></li>
			    <li class="breadcrumb-item"><a href="cubs3Honda.php">Honda</a></li>
			    <li class="breadcrumb-item"><a href="cubs4Motomel.php">Motomel</a></li>
 			</ul>
		</div>
	<hr>
