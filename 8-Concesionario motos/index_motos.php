	...
	<body>
		<div class="jumbotron jumbotron-fluid">
        	<div class="container-fluid">
        		<div class="row">
          			<div class="col-md-10">
        				<h1 style="color: #B60E0E;">Mundo moto
			...
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-5">
						<div class="card alex">
							<img class="lima" src="img/Concesionario_motos/Cubs/Gilera/smash 125 x/1_smashx-slider.png" alt="Gilera">
							<div class="overlay">
    							<div class="text">Gilera Smash 125X</div>
  							</div>   
						</div>
						<button style="width:100%" type="button" class="btn btn-primary" OnClick="location.href='z01.php'">
						    Info
						</button>
					<hr>
						<div class="card alex">
							<img class="lima" src="img/Concesionario_motos/Street/Yamaha/ybr 125 ed/d116c7dc31e49ec8bf115c941060c571_original.jpg" alt="Yamaha">
							<div class="overlay">
    							<div class="text">Yamaha Ybr 125 Ed</div>
  							</div>
						</div>
						<button style="width:100%" type="button" class="btn btn-primary OnClick="location.href='z02.php'"">
						    Info
						</button>
						<hr>
					</div>
					<div class="col-md-5">
						<div class="card alex">
							<img class="lima" src="img/Concesionario_motos/Enduro/corven en/triax 150 r3/1_Triax-150-R3.png" alt="Corven">
							<div class="overlay1">
    							<div class="text">Corven Triax 150 R3</div>
  							</div>
						</div>
						<button style="width:100%" type="button" class="btn btn-primary OnClick="location.href='z03.php'"">
						    Info
						</button>
						<hr>
						<div class="card alex">
							<img class="lima" src="img/Concesionario_motos/Street/corven st/dx 70/1_DX-70.png" alt="Corven">
							<div class="overlay1">
    							<div class="text">Corven Dx 70</div>
  							</div>						    
						</div>
						<button style="width:100%" type="button" class="btn btn-primary OnClick="location.href='z04.php'"">
						    Info
						</button>
						<hr>
					</div>
				...
				<div class="row">
					<div class="col-md-5">
						<div class="card alex">
							<img class="lima" src="img/Concesionario_motos/Cubs/Honda/wave/1_wave.jpg" alt="Honda">
							<div class="overlay">
    							<div class="text">Honda Wave</div>
  							</div>						  
						</div>
						<button style="width:100%" type="button" class="btn btn-primary" OnClick="location.href='z05.php'">
						    Info
						</button>
						<hr>
					</div>
					<div class="col-md-5">
						<div class="card alex">
							<img class="lima" src="img/Concesionario_motos/Cubs/Motomel/blitz/2_Blitz110.png" alt="Motomel">
							<div class="overlay1">
    							<div class="text">Motomel Blitz</div>
  							</div>					    
						</div>
						<button style="width:100%" type="button" class="btn btn-primary" OnClick="location.href='z06.php'">
						    Info
						</button>
						<hr>
					</div>
				...
				<div class="row">
					<div class="col-md-5">
						<div class="card alex">
							<img class="lima" src="img/Concesionario_motos/Street/motomel st/s6/1_S6.png" alt="Motomel">
							<div class="overlay">
    							<div class="text">Motomel S6</div>
  							</div>					    
						</div>
						<button style="width:100%" type="button" class="btn btn-primary" OnClick="location.href='z07.php'">
						    Info
						    </button>
						<hr>
					</div>
					<div class="col-md-5">
						<div class="card alex">
							<img class="lima" src="img/Concesionario_motos/Enduro/Gilera en/sahel 150/1_SAHEL.png" alt="Gilera">
							<div class="overlay1">
    							<div class="text">Gilera Shael 150</div>
  							</div>						    
						</div>
						<button style="width:100%" type="button" class="btn btn-primary" OnClick="location.href='z08.php'">
						    Info
						</button>
						<hr>
					</div>
