...
<html lang="es">
	...
	<body>
		...
		<div style="text-align:center">
		  	<h2>Gilera C 110 Pronto</h2>
		</div>

<!-- The four columns -->
		<div class="row">
		    <div class="column">
		    	<img src="img/Concesionario_motos/Cubs/Gilera/c110 pronto/1_c-110.jpg" alt="" style="width:100%" onclick="myFunction(this);">
		  	</div>
		  	<div class="column">
		    	<img src="img/Concesionario_motos/Cubs/Gilera/c110 pronto/2_c-110.jpg" alt="" style="width:100%" onclick="myFunction(this);">
		  	</div>
		  	<div class="column">
		    	<img src="img/Concesionario_motos/Cubs/Gilera/c110 pronto/3_c-110.jpg" alt="" style="width:100%" onclick="myFunction(this);">
		  	</div>
		  	<div class="column">
		    	<img src="img/Concesionario_motos/Cubs/Gilera/c110 pronto/4_c-110.jpg" alt="" style="width:100%" onclick="myFunction(this);">
		  	</div>
		  	<div class="column">
		    	<img src="img/Concesionario_motos/Cubs/Gilera/c110 pronto/5_c-110.jpg" alt="" style="width:100%" onclick="myFunction(this);">
		  	</div>
		</div>
