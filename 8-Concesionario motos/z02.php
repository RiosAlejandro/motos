...
<html lang="es">
	<head>
		...
		<title>Venta de motos-Cubs</title>

		<link rel="stylesheet" href="css/bootstrap.min.css">
		<!--<link rel="stylesheet" href="css/stylemotos.css">-->
		<link rel="stylesheet" href="css/estilo_individual.css">
	...
	<body>
  				...
  				<ul class="nav nav-tabs">
  					<li class="nav-item dropdown">
					    ...
					    <div class="dropdown-menu">
					      <a class="dropdown-item" href="#"><img src="img/logos-menu/logo_corven.gif" alt="Corven"></a>
		...
		<div style="text-align:center">
		  	<h2>Yamaha Ybr 125 Ed</h2>
		</div>

<!-- The four columns -->
		<div class="row">
		    <div class="column">
		    	<img src="img/Concesionario_motos/Street/Yamaha/ybr 125 ed/1_ed.jpg" alt="" style="width:100%" onclick="myFunction(this);">
		  	</div>
		  	<div class="column">
		    	<img src="img/Concesionario_motos/Street/Yamaha/ybr 125 ed/2_ed.jpg" alt="" style="width:100%" onclick="myFunction(this);">
		  	</div>
		  	<div class="column">
		    	<img src="img/Concesionario_motos/Street/Yamaha/ybr 125 ed/3_ed.jpg" alt="" style="width:100%" onclick="myFunction(this);">
		  	</div>
		  	<div class="column">
		    	<img src="img/Concesionario_motos/Street/Yamaha/ybr 125 ed/4_ed.jpg" alt="" style="width:100%" onclick="myFunction(this);">
		  	</div>
		  	<div class="column">
		    	<img src="img/Concesionario_motos/Street/Yamaha/ybr 125 ed/5_ed.jpg" alt="" style="width:100%" onclick="myFunction(this);">
		  	</div>
		  	<div class="column">
		    	<img src="img/Concesionario_motos/Street/Yamaha/ybr 125 ed/6_ed.jpg" alt="" style="width:100%" onclick="myFunction(this);">
		  	</div>
		  	<div class="column">
		    	<img src="img/Concesionario_motos/Street/Yamaha/ybr 125 ed/7_ed.jpg" alt="" style="width:100%" onclick="myFunction(this);">
		  	</div>
		  	<div class="column">
		    	<img src="img/Concesionario_motos/Street/Yamaha/ybr 125 ed/8_ed.jpg" alt="" style="width:100%" onclick="myFunction(this);">
		  	</div>
		  	<div class="column">
		    	<img src="img/Concesionario_motos/Street/Yamaha/ybr 125 ed/9_ed.jpg" alt="" style="width:100%" onclick="myFunction(this);">
		  	</div>
		  	<div class="column">
		    	<img src="img/Concesionario_motos/Street/Yamaha/ybr 125 ed/10_ed.jpg" alt="" style="width:100%" onclick="myFunction(this);">
		  	</div>
		</div>
		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col md-4">
					<h1 class="mike">Contactanos</h1>
					<div class="vik">
						<button type="button" class="btn btn-danger btn-lg ">info</button>
					</div>
				</div>
			</div>
		</div>
