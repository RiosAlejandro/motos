...
<html lang="es">
	...
	<body>
		...
		<div style="text-align:center">
		  	<h2>Gilera Vc 150R</h2>
		</div>

<!-- The four columns -->
		<div class="row">
		    <div class="column">
		    	<img src="img/Concesionario_motos/Street/gilera st/vc 150 r/1_vc-150-r.jpg" alt="" style="width:100%" onclick="myFunction(this);">
		  	</div>
		  	<div class="column">
		    	<img src="img/Concesionario_motos/Street/gilera st/vc 150 r/2_vc-150-r.jpg" alt="" style="width:100%" onclick="myFunction(this);">
		  	</div>
		  	<div class="column">
		    	<img src="img/Concesionario_motos/Street/gilera st/vc 150 r/3_vc-150-r.jpg" alt="" style="width:100%" onclick="myFunction(this);">
		  	</div>
		  	<div class="column">
		    	<img src="img/Concesionario_motos/Street/gilera st/vc 150 r/4_vc-150-r.jpg" alt="" style="width:100%" onclick="myFunction(this);">
		  	</div>
		  	<div class="column">
		    	<img src="img/Concesionario_motos/Street/gilera st/vc 150 r/5_vc-150-r.jpg" alt="" style="width:100%" onclick="myFunction(this);">
		  	</div>
		</div>
			...
			<div class="row">
				<div class="col-md-8">
					<table style="width:80%">
						...
						<tr>
							<td>Freno trasero</td>
							<td>A tambor de expansión interna</td>
						</tr>
					</table>
