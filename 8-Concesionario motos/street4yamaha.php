					...
					<li class="nav-item dropdown">
  					...
  					<li class="nav-item dropdown">
    					...
    					<div class="dropdown-menu">
      						...
      						<a class="dropdown-item" href="#"><img src="img/logos-menu/logo-yamaha.gif" alt="Yamaha"></a>
    					</div>
  					</li>
  				</ul>
			</nav>
				...
				<div class="row">
					...
					<div class="col-md-5">
						<div class="card alex" ><!--style="width: 500px !important;"-->
							<img class="lima eco" src="img/Concesionario_motos/Street/Yamaha/ybr 125 ed/d116c7dc31e49ec8bf115c941060c571_original.jpg" alt="Yamaha">
							<div class="overlay">
