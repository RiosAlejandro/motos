...
<html lang="es">
	...
	<body>
		...
		<div style="text-align:center">
		  	<h2>Yamaha Ybr 125 Z</h2>
		</div>

<!-- The four columns -->
		<div class="row">
		    <div class="column">
		    	<img src="img/Concesionario_motos/Street/Yamaha/ybr 125 z/1.jpg" alt="" style="width:100%" onclick="myFunction(this);">
		  	</div>
		  	<div class="column">
		    	<img src="img/Concesionario_motos/Street/Yamaha/ybr 125 z/2.jpg" alt="" style="width:100%" onclick="myFunction(this);">
		  	</div>
		  	<div class="column">
		    	<img src="img/Concesionario_motos/Street/Yamaha/ybr 125 z/3.jpg" alt="" style="width:100%" onclick="myFunction(this);">
		  	</div>
		  	<div class="column">
		    	<img src="img/Concesionario_motos/Street/Yamaha/ybr 125 z/4.jpg" alt="" style="width:100%" onclick="myFunction(this);">
		  	</div>
		  	<div class="column">
		    	<img src="img/Concesionario_motos/Street/Yamaha/ybr 125 z/5.jpg" alt="" style="width:100%" onclick="myFunction(this);">
		  	</div>
		  	<div class="column">
		    	<img src="img/Concesionario_motos/Street/Yamaha/ybr 125 z/6.jpg" alt="" style="width:100%" onclick="myFunction(this);">
		  	</div>
		</div>
