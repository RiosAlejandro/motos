				...
				<div class="row">
					...
					<div class="col-md-5">
						<div class="card alex" ><!--style="width: 500px !important;"-->
							<img class="lima eco" src="img/Concesionario_motos/Enduro/corven en/triax 150 r3/1_Triax-150-R3.png" alt="Corven">
							<div class="overlay">
	...
	<hr>
		<div class="container">
			<ul class="breadcrumb justify-content-center">
			    ...
			    <li class="breadcrumb-item"><a href="enduro2Gilera.php">Gilera</a></li>
